...
# All credits to the original author(s) above. 
# I have modified the original script to automatically source the setup files on every new terminal session. - 2021 Arpit Chauhan
